    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!(runningTasks.length > 0)) return [3 /*break*/, 3];
                console.log("Found " + runningTasks.length + " running tasks, resetting them ...");
                return [4 /*yield*/, Promise.all(runningTasks.map(function (task) { return knex.raw('select reset_step_recursively(?)', [task.id]); }))];
            case 2:
                _a.sent();
                console.log("Done.");
                _a.label = 3;
